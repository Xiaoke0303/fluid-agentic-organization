...
- `TRUTH-CONTRACT-v1.md` — 其核心约束已由 [`framework/assurance/TRUTH-CONTRACT.md`](../../framework/assurance/TRUTH-CONTRACT.md) 承接，旧版当前保留为 legacy 来源
- `EXTERNAL-CALL-CHECKLIST.md` — 当前仅被 [`framework/runtime/PRE-FLIGHT-SEQUENCE.md`](../../framework/runtime/PRE-FLIGHT-SEQUENCE.md) 与 [`framework/runtime/OPERATING-RULES.md`](../../framework/runtime/OPERATING-RULES.md) 部分承接，不能视为完整迁移完成
- `FAILURE-REPORT-CHECKLIST.md` — 当前仅被 [`framework/continuity/CORRECTION-WRITEBACK.md`](../../framework/continuity/CORRECTION-WRITEBACK.md) 部分承接，不能视为完整迁移完成
- `schemas/` 与 `templates/` — 当前仍主要保留为 legacy 来源，尚未在 framework 内形成明确的一对一归宿
